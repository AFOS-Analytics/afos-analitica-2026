...
test.describe('SEO', () => {
  test('/sitemap.xml returns valid XML', async ({ request }) => {
    ...
    expect(body).toContain('https://www.afos-analytics.com/pt-BR');
    expect(body).toContain('https://www.afos-analytics.com/en');
    expect(body).toContain('https://www.afos-analytics.com/es');
  });
