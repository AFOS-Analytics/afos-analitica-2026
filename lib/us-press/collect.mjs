 ...
 * jornal de referência, imprensa especializada em Congresso e televisão, com
 * lados nomeados em vez de escondidos. Quem quiser discordar da curadoria pode
 * discordar de uma lista visível, e não de um critério secreto.
 *
...
/**
 * Lista fixa, agrupada pelo papel de cada um e com a inclinação declarada onde
 * ela existe. `casa` é o texto que o Google News devolve no campo `source`.
 */
export const VEICULOS = [
  // Agências: o piso factual, sem linha editorial de opinião no noticiário.
  { casa: 'Reuters', tipo: 'agência', inclinacao: 'centro' },
  { casa: 'Associated Press', tipo: 'agência', inclinacao: 'centro' },
  { casa: 'AP News', tipo: 'agência', inclinacao: 'centro' },

  // Jornais de referência.
  { casa: 'The New York Times', tipo: 'jornal', inclinacao: 'centro-esquerda' },
  { casa: 'The Washington Post', tipo: 'jornal', inclinacao: 'centro-esquerda' },
  { casa: 'The Wall Street Journal', tipo: 'jornal', inclinacao: 'centro-direita' },
  { casa: 'USA TODAY', tipo: 'jornal', inclinacao: 'centro' },

  // Imprensa especializada em Congresso e campanha. É a que mais cobre midterms.
  { casa: 'Politico', tipo: 'especializada', inclinacao: 'centro' },
  { casa: 'The Hill', tipo: 'especializada', inclinacao: 'centro' },
  { casa: 'Roll Call', tipo: 'especializada', inclinacao: 'centro' },
  { casa: 'Axios', tipo: 'especializada', inclinacao: 'centro' },

  // Televisão e rádio pública.
  { casa: 'NPR', tipo: 'tv/rádio', inclinacao: 'centro-esquerda' },
  { casa: 'ABC News', tipo: 'tv/rádio', inclinacao: 'centro' },
  { casa: 'CBS News', tipo: 'tv/rádio', inclinacao: 'centro' },
  { casa: 'NBC News', tipo: 'tv/rádio', inclinacao: 'centro' },
  { casa: 'CNN', tipo: 'tv/rádio', inclinacao: 'centro-esquerda' },
  { casa: 'Fox News', tipo: 'tv/rádio', inclinacao: 'direita' },

  // Opinião declarada, dos dois lados, para a lista não pender.
  { casa: 'Washington Examiner', tipo: 'opinião', inclinacao: 'direita' },
  { casa: 'National Review', tipo: 'opinião', inclinacao: 'direita' },
  { casa: 'The Guardian', tipo: 'opinião', inclinacao: 'esquerda' },

  // Análise eleitoral de casa, não modelo de terceiro republicado.
  { casa: 'The Cook Political Report', tipo: 'análise', inclinacao: 'centro' },
  { casa: 'Sabato’s Crystal Ball', tipo: 'análise', inclinacao: 'centro' },
]
...
const NAO_E_NOTICIA = /latest[\s\w]{0,10}polls|live results|election calendar|poll tracker|results map/i
...
export async function coletarImprensaUs({ maximo = 12, agora = new Date() } = {}) {
  ...
  const acompanhamento = comData.filter((i) => NAO_E_NOTICIA.test(i.titulo))
  const noticias = comData.filter((i) => !NAO_E_NOTICIA.test(i.titulo))
