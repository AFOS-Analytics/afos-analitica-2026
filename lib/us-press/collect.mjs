...
async function buscar(consulta) {
  ...
  // ⏱️ Timeout explícito. Sem ele, 16 feeds buscados em paralelo dentro de uma
  // rota com teto de 30s podiam pendurar a rodada inteira num host lento, e o
  // TimeoutError cai nos catch que já existem, virando `consultasComFalha`.
