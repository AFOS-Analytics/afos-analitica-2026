 ...
 */
export function comparar(antes, depois, excluidas = []) {
 ...
 *   coletor, não o mundo.
 */
export function veredito({ entraram, sairam, mudaram, renomeadas, deduplicadas, duplicaram, excluidasPorInstrumento }, deltaPp) {
  const rotulos = []
...
export function conferirSubtracao(antes, depois, d) {
  ...
  for (const k of ['dem', 'rep']) {
    // 🔑 Todas as seis listas entram, e é isso que impede a classificação nova de
