...
export function compararComBase({ secaoEncontrada, agregadores }, campoMaisRecenteBase, hoje) {
  ...
  const r = { ...base, lidos, referencia, descompassoDias, ultimaAtualizacao, idadeTabelaDias }
  ...
  return {
    ...
    motivo: `diferença de ${descompassoDias} dia(s), dentro da tolerância de ${TOLERANCIA_DIAS}`,
  }
}
