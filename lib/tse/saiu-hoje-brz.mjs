...
export function separarFantasmas(registros, protocolosFantasma) {
  ...
  if (lista == null) return { vivas: registros, retiradas: [], semLedger: true, suspeito: false }
  ...
  return {
    ...
    retiradas,
    semLedger: false,
    // 🕳️ ledger com nomes e nenhum casamento: formato provavelmente mudou
    suspeito: set.size > 0 && retiradas.length === 0 && registros.length > 0,
  }
}
