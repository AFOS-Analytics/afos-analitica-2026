      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="grid sm:grid-cols-3 gap-3 mb-12">
            ...
            <a href={`/${loc}/for-analysts`} className="bg-light-bg border border-light-border rounded-lg p-3 text-sm font-semibold text-dark hover:border-primary transition-colors text-center">→ {loc === 'pt-BR' ? 'Para Analistas' : loc === 'es' ? 'Para Analistas' : 'For Analysts'}</a>
            <a href={`/${loc}/geopolitical-signals`} className="bg-light-bg border border-light-border rounded-lg p-3 text-sm font-semibold text-dark hover:border-primary transition-colors text-center">→ {loc === 'pt-BR' ? 'Sinais Geopolíticos' : loc === 'es' ? 'Señales Geopolíticas' : 'Geopolitical Signals'}</a>
            <a href={`/${loc}/emerging-markets-risk`} className="bg-light-bg border border-light-border rounded-lg p-3 text-sm font-semibold text-dark hover:border-primary transition-colors text-center">→ {loc === 'pt-BR' ? 'Mercados Emergentes' : loc === 'es' ? 'Mercados Emergentes' : 'Emerging Markets'}</a>
            <a href={`/${loc}/global-election-calendar`} className="bg-light-bg border border-light-border rounded-lg p-3 text-sm font-semibold text-dark hover:border-primary transition-colors text-center">→ {loc === 'pt-BR' ? 'Calendário Eleitoral' : loc === 'es' ? 'Calendario Electoral' : 'Election Calendar'}</a>
          </div>
