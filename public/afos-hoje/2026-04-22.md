...
Um dado estadual novo ponderado: no Rio Grande do Sul, o [Diário do Poder](https://www.diariodopoder.com.br) registrou Flávio Bolsonaro com **42.2% contra 28.2% de Lula** — gap de 14 pontos percentuais a favor do ex-senador no estado.
...
Do lado do governo, a campanha de Lula pediu formalmente a retirada de um vídeo publicado por Flávio que associa o presidente à corrupção ([Folha](https://www.folha.uol.com.br)). O PT iniciou uma ofensiva religiosa contra o ex-senador, usando passagens bíblicas ([Metrópoles](https://www.metropoles.com)). O ambiente foi descrito por [Tribuna da Internet](https://tribunadainternet.com.br) como "guerra de narrativas em eleição marcada pela rejeição".
