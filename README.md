...
│   ├── cron/refresh-us-press/         # Cron 3x/day → US press, fixed outlet list
...
| `/api/cron/refresh-us-press` | Cron 3x/day, US press from a fixed outlet list → Neon. Same refuse-on-empty gate |
