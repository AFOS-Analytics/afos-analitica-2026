...
O dataset **Brasil 2026** tem, adicionalmente, uma versao academica curada e citavel no **[Harvard Dataverse](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/2D0UK7)** — DOI [10.7910/DVN/2D0UK7](https://doi.org/10.7910/DVN/2D0UK7), um snapshot versionado e permanente do mirror ao vivo do Hugging Face, depositado no maior repositorio de dados de ciencias sociais. Ate onde verificamos, e o primeiro dataset no Harvard Dataverse a cruzar mercados de previsao × pesquisas registradas × cobertura de imprensa para medir divergencia explicita numa eleicao brasileira.
