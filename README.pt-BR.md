...
Os **11 datasets ENCERRADOS** tem, adicionalmente, snapshots academicos curados e citaveis no **[Harvard Dataverse](https://dataverse.harvard.edu/dataverse/afos-analytics)**, agrupados na colecao **AFOS Analytics**, **cada um com seu proprio DOI** (11 datasets, ex.: Franca [10.7910/DVN/N51NQF](https://doi.org/10.7910/DVN/N51NQF), Brasil [10.7910/DVN/2D0UK7](https://doi.org/10.7910/DVN/2D0UK7), EUA [10.7910/DVN/3DJCW5](https://doi.org/10.7910/DVN/3DJCW5)), cada um um snapshot versionado e permanente do seu mirror ao vivo do Hugging Face, depositado no maior repositorio de dados de ciencias sociais. ⚠️ **O bundle das midterms de 2026 NAO esta entre eles**: um DOI vale mais numa versao que carrega o resultado certificado, e o deposito espera a v2, depois de 3/Nov. Ate onde verificamos, o deposito do Brasil 2026 e o primeiro no Harvard Dataverse a cruzar mercados de previsao × pesquisas registradas × cobertura de imprensa para medir divergencia explicita numa eleicao brasileira.
