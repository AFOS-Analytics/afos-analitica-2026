...
O `backup/neon/` guarda CSV comprimido particionado por mes, commitado neste repositorio. Mes fechado nunca mais muda, entao o git guarda uma vez so. Estado atual: 38 arquivos, cerca de 6,6 MB comprimidos. E o mesmo arquivo que a conferencia de superlativo le (ver *Extremos de série e superlativos* acima).
