...
**Um sumiço numa leitura só não é uma retirada, e a especificidade da afirmação não é evidência dela (10/Set/2026).** O registro público de pesquisas do Tribunal Superior Eleitoral é um arquivo servido por rede de distribuição, e nós o lemos inteiro a cada rodada. Numa rodada da tarde ele trouxe oitocentos e cinquenta e um registros. Cerca de uma hora depois, no espelhamento do dataset, trouxe **oitocentos e sessenta e três**: treze a mais, todos com data de registro do dia anterior, e **um a menos**. Esta casa tem uma régua verdadeira e forte sobre isso, a de que o tribunal retira pesquisas do arquivo e o nosso banco só soma, e é exatamente ela que faz um sumiço parecer significado. Fui buscar quem havia sumido, encontrei o protocolo com instituto, cargo, datas de campo e uma divulgação prevista para aquele mesmo dia, e publiquei a retirada como fato, no dataset, na ficha de memória e na mensagem do commit. **Não houve retirada nenhuma.** A leitura seguinte devolveu oitocentos e cinquenta e um outra vez, e a comparação de conjuntos contra a primeira leitura do dia deu **zero diferença nos dois sentidos**: o protocolo estava lá, e sempre esteve. O que faltava à régua era a outra metade, e ela é barata: **uma retirada só é uma retirada se reproduz numa segunda leitura**, porque uma origem servida por rede de distribuição entrega dois retratos diferentes do mesmo arquivo com minutos de distância, e uma leitura só não separa evento de inconsistência de borda. É a mesma forma da trava que esta casa já aplica ao mercado de previsão, onde duas leituras que concordam são um preço e duas que discordam são um livro em trânsito; a diferença é que ali a régua estava escrita e aqui não. O que pegou o erro não foi atenção, foi um instrumento escrito horas antes no mesmo dia: a sequência do espelho passou a imprimir a contagem de linhas de cada artefato antes e depois, e a linha que dizia que o registro tinha ido de oitocentos e sessenta e três para oitocentos e cinquenta e um obrigou a olhar. Sem ela o dataset público ficaria com treze registros que a fonte não serve e sem um que ela serve, e a nossa própria memória guardaria uma retirada inventada com nome e sobrenome. **Eu tinha o instituto, o cargo, o cadastro da empresa e as datas de campo de uma coisa que nunca aconteceu**, e foi justamente esse detalhamento que fez a afirmação soar apurada.
