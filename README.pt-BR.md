...
│   ├── cron/refresh-us-press/         # Cron 3x/dia → imprensa EUA, lista fixa
...
| `/api/cron/refresh-us-press` | Cron 3x/dia, imprensa dos EUA por lista fixa de veiculos → Neon. Mesmo portao de recusa |
