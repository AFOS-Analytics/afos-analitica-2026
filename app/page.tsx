...
// ─── Candidates ──────────────────────────────────────────────────────
const candidates = [
  { name: "Lula", party: "PT", age: 80, role: "Presidente da República", polymarket: "41.5%", poll: "41-46%", position: "Centro-esquerda. Programas sociais, intervencionismo estatal. 3º mandato.", risk: "Rejeição recorde 50.6%. Caiu 1pp no Polymarket (era 42.5%). Escândalo Banco Master + INSS/Lulinha + crise STF. PT admite plano B." },
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "37.9%", poll: "37-52%", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "Rejeição 24%. Pai inelegível. Zero experiência executiva. PL liderou janela partidária." },
  { name: "Renan Santos", party: "Missão", age: 35, role: "Fundador do MBL", polymarket: "6.35%", poll: "1-4.5%", position: "Direita liberal. Anti-establishment. Foco em jovens e redes sociais.", risk: "Partido pequeno. Baixa estrutura nacional. Força real menor que digital." },
  { name: "Fernando Haddad", party: "PT", age: 63, role: "Ministro da Fazenda", polymarket: "5.0%", poll: "21-38% (sem Lula)", position: "Centro-esquerda. Plano B do PT se Lula não concorrer. Gestor técnico.", risk: "Caiu 1.7pp no Polymarket (era 6.7%). Desgaste como Min. da Fazenda. Perde para Flávio sem Lula." },
  { name: "Ronaldo Caiado", party: "PSD", age: 76, role: "Governador de Goiás", polymarket: "2.75%", poll: "3-5%", position: "Centro-direita. Agronegócio, gestão fiscal. Pré-candidato oficial pelo PSD.", risk: "Não escala além de 5%. Perde no 2T por 7-10pp. PSD sem identidade clara." },
  { name: "Romeu Zema", party: "Novo", age: 56, role: "Governador de Minas Gerais", polymarket: "1.55%", poll: "3-6%", position: "Direita liberal. Privatizações, estado mínimo. Gestão fiscal rigorosa em MG.", risk: "Partido sem estrutura nacional. Dificuldade de alianças." },
