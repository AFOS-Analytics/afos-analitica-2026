...
const candidates = [
  ...
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "37.7%", poll: "30-64%", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "Rejeição 24%. Pai inelegível. Zero experiência executiva. PL liderou janela partidária." },
