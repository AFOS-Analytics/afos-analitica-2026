...
// ─── Candidates ──────────────────────────────────────────────────────
const candidates = [
  { name: "Lula", party: "PT", age: 80, role: "Presidente da República", polymarket: "41.5%", poll: "19-46%", position: "Centro-esquerda. Programas sociais, intervencionismo estatal. 3º mandato.", risk: "Rejeição recorde 50.6%. Gap encurtando (3.45pp). Escândalo Banco Master + INSS/Lulinha + crise STF. 11 voos Vorcaro-STF." },
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "38.05%", poll: "30-56%", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "Rejeição 24%. Pai inelegível. Zero experiência executiva. PL liderou janela partidária (114+ deputados)." },
  { name: "Renan Santos", party: "Missão", age: 35, role: "Fundador do MBL", polymarket: "6.2%", poll: "1-4.5%", position: "Direita liberal. Anti-establishment. Foco em jovens e redes sociais.", risk: "Partido pequeno. Baixa estrutura nacional. Força real menor que digital." },
  { name: "Fernando Haddad", party: "PT", age: 63, role: "Ministro da Fazenda", polymarket: "4.65%", poll: "21-38% (sem Lula)", position: "Centro-esquerda. Plano B do PT se Lula não concorrer. Gestor técnico.", risk: "Em queda no Polymarket (era 6.7%, agora 4.65%). Mercado descarta plano B. Perde para Flávio sem Lula." },
  { name: "Ronaldo Caiado", party: "PSD", age: 76, role: "Governador de Goiás", polymarket: "2.85%", poll: "3-5%", position: "Centro-direita. Agronegócio, gestão fiscal. Pré-candidato oficial pelo PSD.", risk: "Planeja capturar eleitorado de Flávio (Tribuna do Planalto). Não escala além de 5%." },
