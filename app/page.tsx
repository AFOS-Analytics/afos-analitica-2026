...
// ─── Candidates ──────────────────────────────────────────────────────
const candidates = [
  { name: "Lula", party: "PT", age: 80, role: "Presidente da República", polymarket: "43%", poll: "19-46%", position: "Centro-esquerda. Programas sociais, intervencionismo estatal. 3º mandato.", risk: "Rejeição RECORDE 56% (Quaest, 05/Abr). Gap Polymarket 3pp. 2T EMPATADO: Quaest 41% x 41%. Candidacy rejection 66% (+4pp). CPI: Master 'lavanderia do PCC' (relatório 14/Abr)." },
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "40%", poll: "30-56%", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "Rejeição 55% (Quaest, quase igual a Lula 56%). 2T EMPATADO 41% x 41% (Quaest). Carlos Bolsonaro pré-candidato SC. 'Nós venceremos' (04/Abr). PL Senado 72% Polymarket." },
