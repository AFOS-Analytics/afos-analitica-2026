...
const candidates: CandidateProfile[] = [
  ...
  },
  {
    ...
    risk: "QUEDA de 0,05pp, de 0,30% para 0,25% (vol USD 5,98M acumulado), leitura confirmada de 25/Ago, 15:22 BRT (18:22 UTC), abaixo do corte de 0,5% que o painel usa para separar preço de ruído. ⭐ O DIA DELE FOI DE EXPOSIÇÃO E NÃO DE PREÇO: foi sabatinado por cerca de 40 minutos no Jornal Nacional em 25/Ago, segundo BBC e O Globo. Na sabatina minimizou a situação fiscal de Minas Gerais, criticou o STF, disse que o Judiciário é usado para fazer política, não garantiu aumento real do salário mínimo e buscou se afastar de acusações de ligação da Cemig com o Banco Master. O contrato não registrou nada disso."
  },
  {
