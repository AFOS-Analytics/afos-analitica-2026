...
const candidates: CandidateProfile[] = [
  {
    ...
    polymarket: "54,50%",
    poll: "A ÚNICA NACIONAL COM NÚMEROS PUBLICADOS NESTA QUINTA É A PODERDATA (n=3.000, campo 30/Ago a 02/Set, margem de 2pp, BR-07561/2026, contratante o próprio instituto). Outras duas tinham divulgação marcada no registro do TSE, a Datafolha e a 100 Cidades, e nenhuma das duas tinha números publicados no momento desta leitura. Ela lhe dá 37% no 1º turno, contra 38% na rodada da mesma casa de 27/Ago e 41% na de 13/Ago. NUM 2º TURNO CONTRA O SEGUNDO COLOCADO ELE FICA ATRÁS PELA PRIMEIRA VEZ NAS TRÊS RODADAS DESTA CASA DESDE 13/Ago, 44% a 45%. Vence os outros três pares testados: 44% a 42% contra Ronaldo Caiado, 44% a 42% contra Romeu Zema e 44% a 39% contra Renan Santos. A casa não publicou rejeição nem avaliação de governo na tabela conferida. NO PREÇO, leitura confirmada de 03/Set, 15:22 BRT (18:22 UTC), em 54,50% (vol USD 9,63M acumulado), QUEDA de 1,00pp.",
    position: "Centro-esquerda. Programas sociais, intervencionismo estatal. 3º mandato presidencial.",
    risk: "QUEDA de 1,00pp, para 54,50% (vol USD 9,63M acumulado), leitura confirmada de 03/Set, 15:22 BRT (18:22 UTC), depois de cinco dias parado em 55,50%. OS DOIS PRIMEIROS CAÍRAM NO MESMO DIA, e é isso que separa esta rodada da anterior: a distância entre eles encolheu para 14,15pp, contra 14,85pp na véspera, mas desta vez porque ele caiu mais, e não porque o adversário subiu. NA URNA DECLARADA, ELE APARECE ATRÁS NO 2º TURNO PELA PRIMEIRA VEZ NAS TRÊS RODADAS DESTA CASA DESDE 13/Ago, 44% a 45%, e a Genial/Quaest da véspera, com campo sobreposto, mediu o mesmo par ao contrário, 42% a 41%. As duas distâncias são de 1 ponto e as duas casas declaram margem de 2pp. Fez às 15h no Planalto a cerimônia em que declarou zerada a fila do INSS, pelo critério de prazo legal de análise, segundo Poder360 e O Globo."
  },
  {
    ...
    role: "Senador (RJ)",
    polymarket: "40,35%",
    poll: "A ÚNICA NACIONAL COM NÚMEROS PUBLICADOS NESTA QUINTA É A PODERDATA (n=3.000, campo 30/Ago a 02/Set, margem de 2pp, BR-07561/2026, contratante o próprio instituto). Outras duas tinham divulgação marcada no registro do TSE, a Datafolha e a 100 Cidades, e nenhuma das duas tinha números publicados no momento desta leitura. Ela o dá em 34% no 1º turno, contra 35% nas rodadas da mesma casa de 13/Ago e 27/Ago. NO 2º TURNO ELE APARECE NUMERICAMENTE À FRENTE PELA PRIMEIRA VEZ NAS TRÊS RODADAS DESTA CASA DESDE 13/Ago, 45% a 44%, depois de 45% a 46% em 13/Ago e 44% a 45% em 27/Ago. A distância de 1 ponto está dentro da margem declarada de 2pp, ou seja, é empate técnico pela régua da própria casa. NO PREÇO, leitura confirmada de 03/Set, 15:22 BRT (18:22 UTC), em 40,35% (vol USD 9,59M acumulado), QUEDA de 0,30pp.",
    position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.",
    risk: "QUEDA de 0,30pp, para 40,35% (vol USD 9,59M acumulado), leitura confirmada de 03/Set, 15:22 BRT (18:22 UTC). Ele caiu no mesmo dia em que o líder caiu 1,00pp, e a alta de 1,70pp da véspera não teve continuidade. AS DUAS MEDIÇÕES SEGUEM APONTANDO PARA LADOS DIFERENTES, agora com os sinais trocados: no preço ele cede, e na urna declarada faz o melhor resultado da própria série no par que decide a eleição, aparecendo à frente pela primeira vez nas três rodadas desta casa desde 13/Ago. No 1º turno, porém, ele também cedeu dentro da mesma casa, de 35% para 34%. Usou a crise no Supremo para tentar impulsionar o ato de 7 de Setembro, segundo Folha de S.Paulo."
  },
  {
    name: "Renan Santos",
    party: "Missão",
