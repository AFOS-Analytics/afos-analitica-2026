...
const candidates: CandidateProfile[] = [
  {
    ...
    risk: "EVENTOS 30/Mai D+16: aliados de Lula pedem que a PGR investigue Flávio por possível atentado à soberania nacional após a decisão dos EUA sobre PCC/CV (Estadão 30/Mai) — escalada da ofensiva petista sobre o tema. Moro se lança no PR ao lado de Flávio e ataca Lula (Folha 30/Mai). Vox SP 30/Mai: Flávio e Lula empatam no 2T paulista (Poder360, cenário estadual). MANTIDOS 29/Mai: 🌎 EUA CLASSIFICAM PCC/CV TERRORISTAS (BBC, G1, O Globo, Estadão, Valor, Folha), bandeira que Flávio pediu publicamente 28/Mai. Mitigantes: porta-voz do Departamento de Estado EUA NEGA influência de Flávio (G1, Estadão); Valor 'NÃO reverte crise Master'; PF envia parecer à PGR para investigar remessa Vorcaro aos EUA a pedido de Flávio (Valor). 🏛️ PACHECO encerra carreira e fica fora de MG (G1, Estadão, Gazeta do Povo) — frustra projeto do PT no 2º maior colégio eleitoral; Lula reenvia Messias ao STF após rejeição do Senado (Portal iG). JOTA Agregador 29/Mai: 'favoritismo Lula em pico do ciclo' (síntese 11 institutos). STF impeach 5.45% estável. MAS rejeição Lula 45% próxima de Flávio 46% (Datafolha 22/Mai mantida)."
  },
  {
    ...
    risk: "EVENTOS 30/Mai D+16: aliados de Lula pedem que a PGR investigue Flávio por possível atentado à soberania nacional após a decisão dos EUA sobre PCC/CV (Estadão 30/Mai) — nova frente de pressão direta sobre Flávio. Moro se lança no PR ao lado de Flávio, ataca Lula e chama o ato de Trump sobre PCC/CV de 'extraordinário' (Folha 30/Mai) — consolida palanque no PR e alinhamento à pauta de segurança. Vox SP 30/Mai: Flávio empata com Lula no 2T paulista (Poder360, cenário estadual). MANTIDOS 29/Mai: 🌎 EUA CLASSIFICAM PCC/CV TERRORISTAS (BBC, G1, O Globo, Estadão, Valor, Folha), bandeira que Flávio pediu 28/Mai; Bolsonaro orienta Flávio a explorar o tema (O Globo). Mitigantes críticos: porta-voz do Departamento de Estado EUA NEGA influência de Flávio (G1, Estadão); Valor 'decisão ajuda nas redes mas NÃO reverte crise Master'; PF envia parecer à PGR para investigar remessa Vorcaro aos EUA a pedido de Flávio (Valor); Estadão 'improvável reverter a decisão'. Cláudio Castro confirma desistência do Senado RJ (Congresso em Foco). MICHELLE segue caindo no Poly, agora 0.65% (↓0.40pp 24h). Mantidos 22-23/Mai: rejeição Flávio 46% > Lula 45%; JOTA antipetismo como amortecedor no 2T. STF impeach 5.45% estável."
  },
  {
    name: "Renan Santos",
    party: "Missão",
