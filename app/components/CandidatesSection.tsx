...
const candidates: CandidateProfile[] = [
  { name: "Lula", party: "PT", age: 80, role: "Presidente da República", polymarket: "42%", poll: "39% 1T (Datafolha campo)", position: "Centro-esquerda. Programas sociais, intervencionismo estatal. 3º mandato.", risk: "42% Poly (estável). Datafolha campo (7-9/Abr): 39% 1T vs Flávio 33% — liderança 6pp. Resultado 2T: 11/Abr. Rejeição candidatura 66% Quaest (↑4pp vs 62% mar). STF impeach 17% (102 pedidos)." },
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "38%", poll: "33% 1T (Datafolha campo)", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "38% Poly (↑1pp, gap -4pp). Nova Atlas: 0.1pp à frente de Lula. Datafolha campo: 33% 1T vs Lula 39%. Atlas 2T (25/Mar): 47.6% vs 46.6% (à frente). Resultado 2T Datafolha: 11/Abr. PL Senado 72%." },
  { name: "Renan Santos", party: "Missão", age: 35, role: "Fundador do MBL", polymarket: "6.75%", poll: "~3% 1T (Datafolha campo)", position: "Direita liberal. Anti-establishment. Foco em jovens e redes sociais.", risk: "3º lugar 35% Polymarket (↑0.5pp). Datafolha campo: ~3% 1T (subregistro vs Atlas 4.4-4.6%). 24.7% entre jovens 16-24. Caiado ameaça 3º lugar (30%)." },
