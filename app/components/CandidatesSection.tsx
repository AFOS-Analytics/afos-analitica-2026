...
const candidates: CandidateProfile[] = [
  {
    ...
    polymarket: "64,50%",
    poll: "NACIONAL NOVA: a Genial/Quaest saiu em 14/Ago às 21:00 (n=2.004, presencial, campo 10 a 13/Ago, BR-06773/2026) com 38% no 1º turno e 43% x 40% no returno. Contra a própria casa em 05/Ago ele cede 1 ponto nos dois turnos, e os 38% são o piso das nove nacionais desde 05/Ago. Rejeição em 52%, abaixo dos 54% do adversário. Aprovação do governo em 46% contra 48%. NO PREÇO, leitura confirmada nova em 15/Ago, às 13:33 BRT (16:33 UTC). Em 64,50% (vol USD 8,29M acumulado), alta de 1,00pp, rompendo o patamar de 63,50% em que estava desde 09/Ago.",
  ...
  },
  {
    ...
    role: "Senador (RJ)",
    polymarket: "28,15%",
    poll: "NACIONAL NOVA: a Genial/Quaest de 14/Ago lhe dá 31% no 1º turno e 40% no returno, a 3pp do líder. É a primeira nacional a mostrá-lo encurtando os DOIS turnos contra a própria casa, ganhando 1 ponto em cada contra 05/Ago. Rejeição de 54%, a maior do quadro e acima dos 52% do líder. NO PREÇO, leitura confirmada nova em 15/Ago, às 13:33 BRT (16:33 UTC). Em 28,15% (vol USD 8,23M acumulado), alta de 0,30pp e segundo dia seguido de alta. Mesmo subindo ele ficou mais longe do líder, porque o líder subiu 1,00pp. NO CARTÓRIO, a candidatura presidencial foi registrada em 14/Ago e o prazo termina em 15/Ago.",
  ...
  },
  {
    ...
    polymarket: "7,15%",
    poll: "A Genial/Quaest de 14/Ago o mantém em 4% no 1º turno, exatamente o mesmo valor de 05/Ago, ou seja, nove dias sem avanço contra a própria régua. Seguem os 5% da Gerp, os 4% da BTG/Nexus, os 4,7% da Meio/Ideia e os 10% da Palver pela internet. Na PoderData de 13/Ago ele é o único do pelotão que o líder vence no returno. NO PREÇO, não há leitura confirmada nova em 15/Ago, e o valor exibido é o da última leitura confirmada, de 14/Ago, 14:46 BRT. Em 7,15% (vol USD 9,59M acumulado). Ele mantém o maior volume acumulado do book presidencial entre os nomes acima de 1%, e o preço segue entre os dois métodos da urna.",
  ...
  },
  {
    ...
    polymarket: "0,15%",
    poll: "A Genial/Quaest de 14/Ago não o testa em cenário presidencial, e nenhuma nacional da janela o inclui. Ele disputa o governo de São Paulo, e qualquer cenário presidencial que o inclua é hipótese de pesquisa, não candidatura em curso. NO PREÇO, não há leitura confirmada nova em 15/Ago, e o valor exibido é o da última leitura confirmada, de 14/Ago, 14:46 BRT. Em 0,15% (vol USD 7,06M acumulado), abaixo do corte de 0,5%.",
  ...
  },
  {
    ...
    role: "Ex-Gov. Goiás",
    polymarket: "1,05%",
    poll: "A Genial/Quaest de 14/Ago lhe dá 4% no 1º turno, o mesmo de 05/Ago, e traz o dado que faltava: REJEIÇÃO de 35%, contra 54% e 52% dos dois primeiros, com desconhecimento alto declarado pela casa. Rejeição baixa com desconhecimento alto não é aceitação, porque a maior parte do eleitorado ainda não formou opinião. Ele segue empatando com o líder no returno da PoderData de 13/Ago. NO PREÇO, não há leitura confirmada nova em 15/Ago, e o valor exibido é o da última leitura confirmada, de 14/Ago, 14:46 BRT. Em 1,05% (vol USD 5,70M acumulado).",
  ...
  },
  {
    ...
    polymarket: "0,35%",
    poll: "A Genial/Quaest de 14/Ago o mantém em 2% no 1º turno, o mesmo valor de 05/Ago. Seguem os 2% da Gerp, os 3% da BTG/Nexus e os 2,6% da Meio/Ideia. Ele empata com o líder no returno da PoderData de 13/Ago. NO PREÇO, não há leitura confirmada nova em 15/Ago, e o valor exibido é o da última leitura confirmada, de 14/Ago, 14:46 BRT. Em 0,35% (vol USD 5,07M acumulado), abaixo do corte de 0,5% que o painel usa para separar preço de ruído. Ele é o único do pelotão com registro de candidatura já apresentado ao TSE, feito em 06/Ago, e por isso o prazo que termina em 15/Ago não o pressiona.",
  ...
  },
  {
    ...
    polymarket: "0,05%",
    poll: "A Genial/Quaest de 14/Ago não o testa em cenário presidencial, e o mesmo valia para todas as nacionais da janela. Ausência de teste é informação que o painel registra, em vez de repetir dado antigo como se fosse novo. Ele disputa a REELEIÇÃO no governo de São Paulo. NO PREÇO, não há leitura confirmada nova em 15/Ago, e o valor exibido é o da última leitura confirmada, de 14/Ago, 14:46 BRT. Em 0,05% (vol USD 13,91M acumulado), abaixo do corte de 0,5% e sobre o maior volume acumulado de todo o book presidencial.",
