...
const candidates: CandidateProfile[] = [
  {
    ...
    risk: "CRUZAMENTO RARO em 28/Jul, e ele não é entre mercado e pesquisa, é entre mercado e modelo. Felipe Nunes, CEO da Quaest, afirmou no almoço empresarial do Lide, em São Paulo, que a chance de reeleição de Lula está em 60%, contra 38% no início do ano, num modelo que associa aprovação do governo à probabilidade de reeleição. O Polymarket marca 63,50%. É a primeira vez neste painel em que as duas fontes estimam a MESMA grandeza, probabilidade de vitória, e não probabilidade contra intenção de voto, que não podem ser subtraídas uma da outra. A distância é de 3,50pp. Proximidade não é validação, assim como divergência não seria prova de erro. EVENTOS: noticiou-se que Trump prorrogará por um ano a emergência nacional sobre o Brasil, com aviso previsto no Federal Register de 29/Jul, o que mantém a base jurídica das sobretaxas sem criar sanção nova; e o governo brasileiro formalizou em 27/Jul o pedido de consultas na OMC. STF impeach CAIU 0,60pp, para 2,80%. Volume no presidencial em USD 116,26M."
  },
  {
