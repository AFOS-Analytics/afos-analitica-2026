...
const candidates: CandidateProfile[] = [
  ...
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "37%", poll: "35% 1T (Datafolha, 11/Abr) / 35.9% (Veritá — LIDERA)", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "37% Poly (ESTÁVEL). DATAFOLHA (11/Abr): 2T FLÁVIO 46% × LULA 45% — À FRENTE. QUAEST (10/Abr): 2T empatam — 5º instituto. Rejeição 46% (2pp abaixo de Lula). Veritá: 35.9% LIDERA 1T. FLÁVIO (11/Abr, Porto Alegre): 'Não apenas Bolsonaro, mas TODOS os perseguidos subirão a rampa do Planalto' — pós-Datafolha. MASTER não o contamina diretamente. Senado PL 72%." },
  { name: "Renan Santos", party: "Missão", age: 35, role: "Fundador do MBL", polymarket: "6.75%", poll: "4.4% 1T (AtlasIntel, 18-23/Mar) / 1.8% (Veritá, ~40k)", position: "Direita liberal. Anti-establishment. Foco em jovens e redes sociais.", risk: "3º lugar 35% Polymarket (estável). Datafolha (11/Abr): NÃO medido. Veritá: 1.8%. 24.7% entre jovens 16-24. Campo anti-establishment: MASTER pagamentos a Temer/Lewandowski/Mantega alimentam narrativa anti-sistema. ZEMA DESCARTA VICE FLÁVIO (9/Abr): campo fragmentado. Quaest nova (15/Abr)." },
  ...
  { name: "Ronaldo Caiado", party: "PSD", age: 76, role: "Ex-Gov. Goiás (renunciou 4/Abr)", polymarket: "2.3%", poll: "5% 1T (Datafolha, 11/Abr) / 6.5% (Meio/Ideia, 8/Abr)", position: "Centro-direita. Agronegócio, gestão fiscal. Pré-candidato oficial pelo PSD.", risk: "DATAFOLHA (11/Abr): 5% 1T — mediano. 2T Lula 45% × Caiado 42% (Lula vence). REJEIÇÃO 16% (menor de todos). Poly 2.3%, 30% chance 3º lugar. MASTER: RATINHO JR. (aliado PSD, família pagou) contamina campo PSD. LULA CITA CAIADO (9/Abr): acordo Goiás-EUA terras raras. Quaest nova (15/Abr)." },
