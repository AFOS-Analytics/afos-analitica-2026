...
const candidates: CandidateProfile[] = [
  ...
  { name: "Ronaldo Caiado", party: "PSD", age: 76, role: "Ex-Gov. Goiás", polymarket: "2.3%", poll: "6.5% 1T (Meio/Ideia, 8/Abr)", position: "Centro-direita. Agronegócio, gestão fiscal. Pré-candidato oficial pelo PSD.", risk: "Meio/Ideia (8/Abr): FORTE ALTA — 6.5% 1T (maior resultado presencial até agora). Poly 2.3% (estável). 30% de chance de 3º lugar. Caiado enterra 'fantasia da terceira via' e mira eleitorado da direita. Datafolha 11/Abr: resultado decisivo." },
  { name: "Romeu Zema", party: "Novo", age: 56, role: "Ex-Gov. Minas Gerais", polymarket: "1.9%", poll: "4-5% 1T (institutos)", position: "Direita liberal. Privatizações, estado mínimo. Gestão fiscal rigorosa em MG.", risk: "1.9% Poly (estável). Renunciou MG. Novo condiciona candidatos Senado a voto pró-impeachment STF. STF impeach voltou a 17% (↑3pp). 13.5% de chance de 3º lugar. Caiado (6.5% Meio/Ideia) pressiona espaço." },
