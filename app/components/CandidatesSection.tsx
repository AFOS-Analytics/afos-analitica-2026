...
const candidates: CandidateProfile[] = [
  ...
  },
  {
    ...
    risk: "SEM VARIAÇÃO, em 2,25% (vol USD 11,88M acumulado), leitura confirmada de 30/Ago, 16:40 BRT (19:40 UTC). O DADO É A AUSÊNCIA DE MOVIMENTO EM DOIS DIAS: Dias Toffoli assinou em 29 de agosto, sábado, um despacho que retirou de pauta o registro de candidatura de Renan Santos e do vice Aroldo Medina, que seria julgado no plenário virtual de 31 de agosto. Ele apontou indícios de ilicitude porque a chapa entregou 18 perfis de redes sociais em 19 de agosto, com o pedido de registro protocolado em 7 de agosto, fora do prazo. A decisão veio a público em 30 de agosto, com sete veículos publicando entre 15h47 e 18h56 de Brasília, e o preço não reagiu nem no sábado nem no domingo. O livro dele acumula USD 11,88M, o maior entre os candidatos do painel, num contrato que hoje paga menos de 3%. O TSE começa a julgar os registros de candidatura em 31 de agosto, segundo Veja."
  },
  {
