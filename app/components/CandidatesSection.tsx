...
const candidates: CandidateProfile[] = [
  { name: "Lula", party: "PT", age: 80, role: "Presidente da República", polymarket: "41%", poll: "39% 1T (Datafolha, 11/Abr) / 40.4% (Meio/Ideia, 8/Abr)", position: "Centro-esquerda. Programas sociais, intervencionismo estatal. 3º mandato.", risk: "41% Poly (↓1pp). Gap 4pp. DATAFOLHA (11/Abr): 1T 39% lidera estimulado; 2T FLÁVIO 46% × LULA 45% — FLÁVIO À FRENTE (empate técnico, margem 2pp). Rejeição Lula 48% (nova máxima Datafolha). Quaest (5/Abr): 66% rejeitam candidatura. LULA ATACA (9/Abr): 'Essa gente vai vender o Brasil'. Quaest nova: resultados 15/Abr." },
  { name: "Flávio Bolsonaro", party: "PL", age: 45, role: "Senador (RJ)", polymarket: "37%", poll: "35% 1T (Datafolha, 11/Abr) / 35.9% (Veritá — LIDERA)", position: "Direita conservadora. Herdeiro político de Jair Bolsonaro. Apoia desregulamentação, redução do Estado.", risk: "37% Poly (ESTÁVEL). DATAFOLHA (11/Abr): 2T FLÁVIO 46% × LULA 45% — À FRENTE. Rejeição Flávio 46% (2pp abaixo de Lula). Veritá (~40k): 35.9% LIDERA 1T. CONVERGÊNCIA: Datafolha, Meio/Ideia, Atlas, Paraná — todos 2T empatados ou Flávio à frente. ZEMA DESCARTA VICE (9/Abr). Senado PL 72%." },
  { name: "Renan Santos", party: "Missão", age: 35, role: "Fundador do MBL", polymarket: "6.75%", poll: "4.4% 1T (AtlasIntel, 18-23/Mar) / 1.8% (Veritá, ~40k)", position: "Direita liberal. Anti-establishment. Foco em jovens e redes sociais.", risk: "3º lugar 35% Polymarket (estável). Datafolha (11/Abr): NÃO medido (ausente dos presenciais). Veritá: 1.8%. 24.7% entre jovens 16-24. ZEMA DESCARTA VICE FLÁVIO (9/Abr): campo fragmentado. Quaest nova (15/Abr): próxima medição." },
  { name: "Fernando Haddad", party: "PT", age: 63, role: "Ministro da Fazenda", polymarket: "4.9%", poll: "21-38% (sem Lula)", position: "Centro-esquerda. Plano B do PT se Lula não concorrer. Gestor técnico.", risk: "4.9% Poly (estável). DATAFOLHA (11/Abr): Lula 39% lidera 1T — PT mantém Lula, plano B sem urgência. Quaest (5/Abr): 66% rejeitam Lula — PT sem alternativa viável. LULA ATIVO (9/Abr): 'venderão o Brasil'. VORCARO: impacto bilateral potencial." },
  { name: "Ronaldo Caiado", party: "PSD", age: 76, role: "Ex-Gov. Goiás (renunciou 4/Abr)", polymarket: "2.3%", poll: "5% 1T (Datafolha, 11/Abr) / 6.5% (Meio/Ideia, 8/Abr)", position: "Centro-direita. Agronegócio, gestão fiscal. Pré-candidato oficial pelo PSD.", risk: "DATAFOLHA (11/Abr): 5% 1T — resultado mediano. 2T Lula 45% × Caiado 42% (Lula vence). REJEIÇÃO 16% (menor de todos — vantagem estrutural). Poly 2.3%, 30% chance 3º lugar. LULA CITA CAIADO (9/Abr): acordo Goiás-EUA terras raras. Quaest nova (15/Abr): próximo teste." },
