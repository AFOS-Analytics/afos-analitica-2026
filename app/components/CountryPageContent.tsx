      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between gap-3 mb-6">
          ...
          <div className="flex items-center gap-4">
            <a href={`/${loc}/global`} className="inline-flex items-center whitespace-nowrap rounded-md bg-primary px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-primary/90"><span className="sm:hidden">{l.backToGlobalShort}</span><span className="hidden sm:inline">{l.backToGlobal}</span></a>
