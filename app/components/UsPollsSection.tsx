...
const T = {
  'pt-BR': {
    ...
    semSenado: 'Não existe equivalente para o Senado. Cada assento é disputado estado a estado e pesquisado assim, então uma média nacional de Senado seria invenção. Por isso o mercado de previsão aqui mostra Câmara e Senado, e as pesquisas mostram só a Câmara.',
  ...
  en: {
    ...
    semSenado: 'There is no equivalent for the Senate. Each seat is contested state by state and polled that way, so a national Senate average would be an invention. That is why the prediction market here shows House and Senate, while the polls show only the House.',
  ...
  es: {
    ...
    semSenado: 'No existe equivalente para el Senado. Cada escaño se disputa estado por estado y se encuesta así, de modo que un promedio nacional de Senado sería una invención. Por eso el mercado de predicción aquí muestra Cámara y Senado, mientras que las encuestas muestran solo la Cámara.',
