  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={open}
        className={`fixed z-[60] bottom-5 right-5 h-14 w-14 rounded-full bg-green-600 hover:bg-green-700 text-white shadow-xl flex items-center justify-center transition-all duration-200 hover:scale-105 focus:outline-2 focus:outline-offset-2 focus:outline-green-600 ${open ? 'hidden sm:flex' : 'flex'}`}
      >
        {open ? (
