...
const CONTENT = {
  'pt-BR': {
    ...
    hero: {
      ...
      subtitle: 'Construído e validado durante o ciclo eleitoral 2026 em países na América do Sul. Análises diárias, código aberto Apache 2.0.',
  ...
  en: {
    ...
    hero: {
      ...
      claim: 'The open-source Global Political Risk Intelligence observatory — prediction markets cross-referenced with electoral polls and real-time news.',
      subtitle: 'Built and battle-tested during the 2026 election cycle in South American countries. Daily analysis, Apache 2.0 open-source.',
      cta: 'Open Dashboard',
  ...
  es: {
    ...
    hero: {
      ...
      claim: 'El observatorio open-source de Global Political Risk Intelligence — mercados de predicción cruzados con encuestas electorales y noticias en tiempo real.',
      subtitle: 'Construido y validado durante el ciclo electoral 2026 en países de América del Sur. Análisis diario, código abierto Apache 2.0.',
      cta: 'Abrir Dashboard',
