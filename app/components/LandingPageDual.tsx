...
const CONTENT = {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: 'Built and battle-tested during Brazil\'s 2026 election cycle. Now expanding to 14+ countries. Daily human analysis, Apache 2.0 open-source.',
      cta: 'Open Dashboard',
  ...
  es: {
    ...
    hero: {
      ...
      subtitle: 'Construido y validado durante el ciclo electoral de Brasil 2026. Expandiéndose a 14+ países. Análisis humano diario, código abierto Apache 2.0.',
      cta: 'Abrir Dashboard',
