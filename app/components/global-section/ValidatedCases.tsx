...
const TAGLINE: Record<string, Record<Locale, string>> = {
  ...
  PER: {
    'pt-BR': 'O favorito do mercado por meses (López Aliaga) ficou em 3º e não foi ao 2º turno: divergência sustentada, não ruído. O 2º turno (07/jun) Fujimori × Sánchez terminou em empate técnico (~50,1% × 49,9%), ainda sem vencedor proclamado. Volume total do mercado: **~US$ 88M**.',
    en: "The market's months-long favorite (López Aliaga) placed 3rd and missed the runoff: sustained divergence, not noise. The June 7 runoff (Fujimori × Sánchez) ended in a virtual tie (~50.1% × 49.9%), no winner yet proclaimed. Total market volume: **~US$88M**.",
    es: 'El favorito del mercado por meses (López Aliaga) quedó 3º y no llegó al balotaje: divergencia sostenida, no ruido. El balotaje del 7 jun (Fujimori × Sánchez) terminó en empate técnico (~50,1% × 49,9%), sin ganador proclamado aún. Volumen total del mercado: **~US$88M**.',
  },
  COL: {
