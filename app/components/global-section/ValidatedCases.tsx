...
const TAGLINE: Record<string, Record<Locale, string>> = {
  ...
  IND: {
    'pt-BR': 'A maior eleição da história (~980 milhões de eleitores aptos). O mercado de previsão (**~US$ 835 mil**) e as pesquisas concordaram entre si e superestimaram juntos: acertaram o vencedor (a NDA, de Modi) e erraram muito o tamanho, previram 350 a 400 das 543 cadeiras e deu ~293. O BJP perdeu a maioria que governava sozinho (240). No voto foi quase-empate (43,8% × 41,48%): a oposição se uniu, e o voto estável de Modi virou derrota de cadeira.',
    en: 'The largest election in history (~980M eligible voters). The prediction market (**~US$835k**) and the polls agreed with each other and overestimated together: right on the winner (Modi’s NDA), very wrong on the size, projecting 350 to 400 of 543 seats against ~293. The BJP lost the single-party majority it governed with (240). The vote was a near-tie (43.8% × 41.48%): the opposition unified, and Modi’s stable vote became a seat defeat.',
    es: 'La mayor elección de la historia (~980 millones de electores). El mercado de predicción (**~US$835k**) y las encuestas coincidieron entre sí y sobreestimaron juntos: acertaron el ganador (la NDA, de Modi) y erraron mucho el tamaño, proyectaron 350 a 400 de 543 escaños y fueron ~293. El BJP perdió la mayoría propia (240). En votos fue casi empate (43,8% × 41,48%): la oposición se unió y el voto estable de Modi se volvió derrota de escaños.',
  },
};
