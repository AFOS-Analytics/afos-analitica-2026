...
/**
 * Dashboard Gate — Blocks dashboard access on 4th+ qualified session.
 * Shows blurred dashboard content behind a premium subscribe modal.
 * Wraps children; only blocks when eligible === 'gate'.
 */
...
export function DashboardGate({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative">
      {/* Dashboard content — blurred and non-interactive */}
      <div style={{ filter: 'blur(8px)', pointerEvents: 'none', userSelect: 'none' }} aria-hidden="true">
        {children}
      </div>

      {/* Gate overlay */}
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(4px)' }}>
        <div
        ...
        >
          ...
          <div className="px-6 py-8 sm:px-8">
            ...
            {/* Title */}
            <h2 className="text-dark font-bold text-xl text-center leading-snug mb-2">
              {t('gate.title')}
            </h2>
