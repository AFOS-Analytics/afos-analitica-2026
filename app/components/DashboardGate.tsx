 ...
 *
 * IMPORTANT: Always renders children so dashboard data loads in parallel
 * with visitor state. Gate is an overlay, not a blocker of the render tree.
 */
