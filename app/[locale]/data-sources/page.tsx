...
const CONTENT = {
  'pt-BR': {
    ...
    sections: [
      ...
      ['Calendário eleitoral global', 'IFES (International Foundation for Electoral Systems) e Wikipedia (consolidado). Cobertura de 15 países com eleições nacionais previstas em 2026.'],
  ...
  en: {
    ...
    sections: [
      ...
      ['Global electoral calendar', 'IFES (International Foundation for Electoral Systems) and Wikipedia (consolidated). Coverage of 15 countries with national elections planned for 2026.'],
  ...
  es: {
    ...
    sections: [
      ...
      ['Calendario electoral global', 'IFES (International Foundation for Electoral Systems) y Wikipedia (consolidado). Cobertura de 15 países con elecciones nacionales previstas en 2026.'],
