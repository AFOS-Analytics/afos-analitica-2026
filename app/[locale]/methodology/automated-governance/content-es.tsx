    ...
    <>
      ...
      <div className={S.tableWrap}>
        <table className={S.table}>
          <thead>
            <tr>
              <th scope="col" className={S.th}>Camino</th>
              <th scope="col" className={S.th}>Qué es</th>
              <th scope="col" className={S.th}>Involucramiento AFOS</th>
              <th scope="col" className={S.th}>Reglas</th>
            </tr>
          </thead>
          <tbody>
      ...
      <p className={S.p}>
        ...
        open-source vía <a href="https://github.com/AFOS-Analytics/afos-analitica-2026/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">CONTRIBUTING.md</a>{' '}, nada especial, es solo un PR.
      </p>
      ...
      <p className={S.p}>
        ...
        </a>{' '}, el código es libre, pero el nombre "AFOS Analytics" y el logo son marcas registradas. Los forks operan bajo nombre propio.
      </p>
      <p className={S.p}>
        ...
        <table className={S.table}>
          <thead>
            <tr>
              ...
              <th scope="col" className={S.th}>Qué revisa</th>
              <th scope="col" className={S.th}>Acción en fallo</th>
            </tr>
          </thead>
          <tbody>
      ...
      <p className={S.p}>
        ...
        <a href="https://github.com/AFOS-Analytics/afos-analitica-2026/blob/main/lib/ai/prompts.ts" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-mono text-sm">
          lib/ai/prompts.ts
        </a>{' '}, cualquier cambio pasa por PR revisado.
      </p>
