...
export function HowItWorksEs() {
  return (
    <>
      <p className="text-center text-sm font-extrabold text-primary dark:text-blue-200 uppercase tracking-[0.25em] mb-3">El Método</p>
      <h1 className="text-3xl md:text-4xl font-extrabold text-primary dark:text-white text-center mb-2 tracking-tight">Cómo funciona AFOS Analytics</h1>
      <p className="text-center text-gray-600 dark:text-blue-100 text-base font-medium mb-10">Guía didáctica para navegar la plataforma</p>

      <nav className="bg-white dark:bg-blue-900/40 border border-blue-100 dark:border-blue-400/40 rounded-xl p-6 my-8 shadow-sm" aria-label="Tabla de contenidos">
        <div className="text-xs font-bold text-primary dark:text-blue-200 uppercase tracking-wider mb-4">Tabla de Contenidos</div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <TocCol heading="Recorrido por la plataforma">
            ...
            <TocLink href="#afos-global-card">└ AFOS Global, el Método en el Mundo</TocLink>
      ...
      <Card title="Modal Global" id="modal-global">
        ...
        <p>Actualmente, 15 países son monitoreados, con foco en América Latina (Brasil, México, Colombia, Chile, Perú) y países clave globales (EE.UU., Francia, Reino Unido). Para cada uno, el card muestra fecha de la elección, principales candidatos y enlace a ficha detallada.</p>
        ...
        <p>Este modal es solo la capa <strong>en vivo</strong>. La página <strong>AFOS Global</strong> también reúne los <strong>casos validados</strong> (elecciones ya escrutadas, con mercado × encuesta cruzados contra el resultado real), detallados en el bloque <strong>AFOS Global, el Método en el Mundo</strong> de esta guía.</p>
      </Card>
      ...
      <Card title="Cómo funciona AFOS Daily">
        ...
        <p><strong>Archivo de ediciones:</strong> la página <code>/daily</code> lista <strong>todas las ediciones publicadas</strong>, agrupadas por mes y con la más reciente destacada, con un selector para <strong>ir directo a una fecha</strong> y los mismos selectores de <strong>idioma</strong> (PT · EN · ES) y <strong>tema</strong> (claro / Sapphire Blue). Dentro de cada síntesis, los botones <strong>"← Síntesis anterior"</strong> y <strong>"Próxima síntesis →"</strong> y el enlace <strong>"Todas las ediciones"</strong> llevan al archivo.</p>
      ...
      <p className={S.p}>Si el AFOS Daily es la lectura de todos los días, el <strong>AFOS Tradeoff</strong> es la profundización <strong>semanal</strong>: un brief técnico publicado <strong>cada lunes</strong>, que cubre la semana que pasó. Está dirigido al lector profesional de mercado (research, mesa institucional, tesorería, buy-side), con foco en <strong>pricing y divergencia</strong>, no en narrativa.</p>
      <p className={S.p}>Mientras el Daily cuenta la historia del día, el Tradeoff mide la <strong>variación de la semana</strong> (Δ semana) a partir de snapshots persistidos y lo organiza todo en una estructura fija de lectura rápida para quien necesita una señal accionable.</p>

      <Card title="Cómo funciona el AFOS Tradeoff">
        <p><strong>Cadencia:</strong> semanal, publicado los lunes, cubriendo la semana anterior (cada edición lleva número secuencial, ej.: Edición №2).</p>
        <p><strong>Estructura fija (9 bloques):</strong> resumen ejecutivo (3 cards de métrica), "Por qué AFOS no suaviza" (por qué el promedio ponderado borra señal), 3 escenarios ponderados (base / contrario al pricing / cola), grilla de indicadores, liquidez y estructura de mercado, calendario de encuestas, watch list de disparadores, metodología y lectura macro complementaria.</p>
        <p><strong>Δ semana:</strong> cada contrato muestra precio actual, variación en la semana y volumen USD acumulado, calculados sobre snapshots diarios persistidos, no estimaciones.</p>
        <p><strong>Tono técnico:</strong> sin floritura periodística, sin adjetivos partidarios y <strong>sin recomendación de inversión</strong> (cada edición lleva un aviso financiero fijo). El volumen USD se cita como contexto de "dinero real"; la liquidez de book no se usa como señal editorial.</p>
        <p><strong>3 idiomas, permalink y archivo:</strong> PT-BR · EN · ES, cada edición con su propia URL (<code>/tradeoff/br/2026-06-01</code>). La página <code>/tradeoff</code> es el <strong>archivo de ediciones</strong>: las lista todas (por número y semana), con la más reciente destacada y selectores de <strong>idioma</strong> y <strong>tema</strong> (claro / Sapphire Blue). Dentro de cada edición, los botones de navegación y el enlace <strong>"Todas las ediciones"</strong> llevan al archivo.</p>
      </Card>

      <p className={S.p}><strong>Cuándo vale leerlo:</strong> cuando quieres la <em>lectura de la semana</em> en lugar de la foto del día, dónde el mercado lidera o se atrasa frente a la encuesta, qué cambió de verdad y qué es ruido. El Daily es el pulso diario; el Tradeoff es la radiografía semanal.</p>

      <h2 id="afos-global-card" className={S.h2}>AFOS Global, el Método en el Mundo</h2>
      <p className={S.p}>Si el Daily y el Tradeoff leen el Brasil de hoy, el <strong>AFOS Global</strong> muestra que la misma lectura vale en cualquier elección. La página <strong>Global</strong> tiene dos capas. Arriba, los <strong>Casos validados</strong>: elecciones <strong>ya realizadas</strong>, donde cruzamos el mercado de predicción con las encuestas y verificamos el resultado contra <strong>lo que de hecho pasó en las urnas</strong>. Abajo, la capa <strong>En vivo</strong>: el mapa de odds de las elecciones en curso, solo con la precificación de mercado, sin la capa de encuestas y divergencia.</p>
      <p className={S.p}><strong>Por qué importan los casos validados:</strong> son la prueba del método. En una elección ya escrutada se puede ver, en retrospectiva, cuándo el mercado vio lo que la encuesta no vio y cuándo el mercado se equivocó. Hoy son seis: Brasil, Perú, Colombia, Chile, Alemania y Canadá, de América a Europa.</p>
      <Callout title="El concepto que lo destraba todo: probabilidad no es voto">
        <p>El número del <strong>mercado</strong> es la <strong>probabilidad de ganar la elección</strong>. El número de la <strong>encuesta</strong> es la <strong>porción de intención de voto</strong>, en general de la primera vuelta. Son ejes diferentes, y es exactamente ahí donde vive la señal, no en un error de medición.</p>
        <p><strong>Chile 2025:</strong> las encuestas daban a Jeannette Jara al frente en la primera vuelta (cerca de 26%), mientras el mercado precificaba a José Antonio Kast en torno al 66% de probabilidad de ganar. La encuesta medía el voto de primera vuelta; el mercado ya leía el desenlace, anticipando la unión de la derecha en el balotaje. Kast ganó el balotaje con 58%. La divergencia de +45pp en su línea no fue error de encuesta, fue la señal.</p>
      </Callout>
      <p className={S.p}>Cada caso validado se abre en dos pantallas complementarias:</p>
      <ul className={S.ul}>
        <li>La <strong>página del país</strong> trae el <strong>Análisis de divergencia</strong>: una tabla candidato por candidato con tres columnas, <strong>Encuesta</strong> (porción de voto), <strong>Mercado</strong> (probabilidad de ganar) y <strong>Divergencia</strong> (la diferencia en puntos porcentuales). Cuando un número merece una salvedad, la tabla lo anota en vez de esconderlo. En Perú, por ejemplo, el 31,6% de Carlos Álvarez fue un pico de un día en un mercado de baja actividad, y está marcado como tal.</li>
        <li>La <strong>página de la elección</strong> muestra la tarjeta <strong>"¿Quién gana?"</strong>: la foto del mercado el día de la elección (pre-resultado, con el mercado ya cerrado) y el <strong>volumen acumulado</strong> en dólares, la misma lectura de "dinero real" del dashboard brasileño.</li>
      </ul>
      ...
      <p className={S.p}>El ganador es justamente el nombre que el mercado más sobreprecificaba en relación con la encuesta. Ese es el patrón que el AFOS persigue: la divergencia como señal, no como ruido.</p>
      <p className={S.p}><strong>Datos abiertos:</strong> cada caso validado tiene un <strong>dataset público en Hugging Face</strong>, bajo licencia CC BY 4.0, con las encuestas, las odds y la divergencia calculada. Cualquier persona puede auditar o reproducir el análisis.</p>
      <p className={S.p}><strong>Por qué cubrir el mundo:</strong> donde haya elección, existe señal. El mismo método aplicado de América a Europa muestra que la lectura no es una casualidad brasileña, es estructural.</p>

      <h3 id="contexto-estrutural" className={S.h3Anchor}>Contexto estructural, el marco del país</h3>
      <p className={S.p}>Debajo de las señales electorales, cada caso validado y el panel de Brasil traen un bloque de <strong>Contexto estructural</strong>: indicadores oficiales y abiertos del <strong>Banco Mundial</strong> que enmarcan el país <strong>al lado</strong> de la señal de mercado, no como predictor de ella. Tres grupos: <strong>Gobernanza</strong> (seis Worldwide Governance Indicators, escala 0 a 100: estabilidad política, voz y rendición de cuentas, estado de derecho, efectividad del gobierno, calidad regulatoria, control de corrupción), <strong>Economía</strong> (población, PIB, PIB per cápita, inflación) y <strong>Educación</strong> (gasto público en educación y años esperados de escolaridad). Son indicadores anuales y estructurales, cambian despacio y <strong>no predicen el resultado electoral</strong>, son trasfondo para la lectura. Fuente: World Bank (WGI vía Data360 y WDI v2), abierta y citable.</p>

      <h3 id="grafo-cruzamento" className={S.h3Anchor}>El grafo del cruce, el método se volvió un mapa navegable</h3>
      <p className={S.p}>En cada caso validado y, sobre todo, en el <strong>panel de Brasil</strong>, el cruce ahora tiene un <strong>grafo force-directed estilo Obsidian</strong>. La elección queda en el centro, rodeada por los cuatro pilares (mercados, encuestas, prensa y contexto estructural). La <strong>estrella es la divergencia</strong>: cada candidato se conecta por una línea fina, coloreada por la magnitud (rojo = alta, ámbar = media, verde = convergencia), con el <strong>Δpp escrito sobre la propia línea</strong>. En los casos validados un nodo de <strong>"Resultado real"</strong> apunta en verde a quien de hecho ganó; los nodos de candidatos usan los <strong>colores partidarios</strong>.</p>
      <p className={S.p}>En el panel el grafo es el <strong>cerebro navegable</strong> de la plataforma. Pasa el mouse por un nodo y él y sus conexiones se encienden en azul; haz clic y cada nodo te lleva a su destino: los nodos de <strong>dato</strong> abren la carpeta correspondiente en el <strong>dataset abierto en Hugging Face</strong>, los de <strong>contexto</strong> se desplazan a la tarjeta de contexto de la página, y los <strong>atajos</strong> llevan a los productos (Daily, Tradeoff, Global, White Paper, Gobernanza), a las secciones del panel y al <strong>Harvard Dataverse</strong> (colección + DOI). Es el método entero, dato abierto, elección viva y plataforma, en un solo mapa, en tres idiomas.</p>
      ...
      <h2 id="paises" className={S.h2}>8. Países (botones del dashboard)</h2>
      <p className={S.p}>En el dashboard hay una fila de <strong>botones de país</strong>, atajos directos a la ficha de cada elección monitoreada (15 países: Brasil, EE.UU., Francia, Alemania, Reino Unido, Canadá, Colombia, Chile, Perú, entre otros). Es el camino rápido para salir de Brasil y abrir otro país sin volver a la home.</p>
      <p className={S.p}><strong>La capa internacional completa</strong>, los casos validados, las páginas de país y de elección, y los datasets abiertos, está explicada en el bloque <strong>AFOS Global</strong> (justo después del Daily y el Tradeoff). Aquí en el dashboard, los botones son solo el atajo de navegación.</p>
      ...
      <Card title="Paso 4, Sigue el AFOS Daily y el Tradeoff">
        <p><strong>AFOS Daily (todos los días):</strong> una lectura de ~4 minutos que explica <em>por qué</em> se movieron los números del dashboard, con fuente auditable por afirmación. Es lo que convierte la foto del día en historia.</p>
        <p><strong>AFOS Tradeoff (cada lunes):</strong> el brief técnico de la semana, para quien quiere profundidad de pricing y divergencia (research, mesa, buy-side). Trae el Δ semana, escenarios ponderados y watch list de disparadores.</p>
      </Card>
      ...
      <SummaryFrame>
        AFOS Analytics es la primera plataforma que combina, en tiempo real, mercados de predicción × encuestas de opinión × noticias para mostrar, con honestidad y transparencia, divergencias explícitas en vez de promedios suavizados, revelando lo que los datos realmente dicen sobre política, sin sesgo, sin propaganda, libre y sin registro obligatorio.
      </SummaryFrame>

      <p className="text-center text-xs text-gray-400 dark:text-blue-200/70 mt-10 mb-2">Actualizado en abril de 2026</p>
    </>
  )
}
