  ...
  return (
    <>
      ...
      <Card title="Como o AFOS Tradeoff funciona">
        ...
        <p><strong>3 idiomas, permalink e arquivo:</strong> PT-BR · EN · ES, cada edição com URL própria (<code>/tradeoff/2026-06-01</code>). A página <code>/tradeoff</code> é o <strong>arquivo de edições</strong>: lista todas (por número e semana), com a mais recente em destaque e seletores de <strong>idioma</strong> e <strong>tema</strong> (claro / Sapphire Blue). Dentro de cada edição, os botões de navegação e o link <strong>"Todas as edições"</strong> levam ao arquivo.</p>
      </Card>
