...
const p = InstitutionalPage('geopolitical-signals', {
  'pt-BR': {
    ...
    features: ['Mapa global interativo com 15 países', 'Sinais de mercados de previsão como indicador antecipado', 'Impacto de eleições em câmbio e risco-país', 'Correlação entre eventos políticos e movimentos de mercado', 'Alertas de mudança de cenário político'],
  ...
  en: {
    ...
    features: ['Interactive global map with 15 countries', 'Prediction market signals as leading indicator', 'Election impact on FX and sovereign risk', 'Correlation between political events and market movements', 'Political scenario change alerts'],
  ...
  es: {
    ...
    features: ['Mapa global interactivo con 15 países', 'Señales de mercados de predicción como indicador anticipado', 'Impacto de elecciones en tipo de cambio y riesgo soberano', 'Correlación entre eventos políticos y movimientos de mercado', 'Alertas de cambio de escenario político'],
