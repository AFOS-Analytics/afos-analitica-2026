...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    ...
    alternates: {
      canonical: `https://afos-analytics.com/${params.locale}/privacy`,
      languages: {
        'pt-BR': 'https://afos-analytics.com/pt-BR/privacy',
        en: 'https://afos-analytics.com/en/privacy',
        es: 'https://afos-analytics.com/es/privacy',
      },
    },
  }
}
