...
const CONTENT = {
  ...
  es: {
    ...
    sections: [
      ['Recolección de datos', 'AFOS Analytics recolecta solo lo estrictamente necesario para operar el servicio: (a) dirección de email, cuando optas por recibir alertas; (b) cookie de identificación anónima (afos_visitor_id) para diferenciar sesiones; (c) preferencias de idioma y estado de interfaz; (d) logs de acceso (IP, user-agent) retenidos por 24 horas para mitigación de abuso; (e) contenido anónimo de las conversaciones con el asistente de IA (chatbot), almacenado sin IP y sin ninguna identificación de quién preguntó, retenido por 12 meses, con la finalidad de mejorar el asistente.'],
