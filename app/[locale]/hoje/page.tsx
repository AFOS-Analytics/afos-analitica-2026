        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-gray-700 leading-relaxed">
            <li className="flex gap-3">
              ...
              <span><strong>Lula teve a primeira queda significativa em três dias</strong> (-1pp) e o gap com Flávio ampliou para 1.65pp — a maior do ciclo na direção do senador. O mercado "impeachment STF" bateu nova máxima absoluta (16%). Em conjunto, são sinais consistentes de fortalecimento do campo bolsonarista nacional, ainda que o gap presidencial siga estreito.</span>
            </li>
            <li className="flex gap-3">
