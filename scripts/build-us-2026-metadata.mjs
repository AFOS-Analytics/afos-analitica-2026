...
- 🗑️ **One whole day is missing on purpose: 2026-04-28 was removed from the series on 2026-09-05, all 980 points across 18 contracts.** From 11:45 UTC that day the collector wrote values near 50% for unrelated books in the same second, including **both sides of the Senate contract at once**, and the values then decayed back over up to eight hours. Measured across the 971 snapshots holding 20 points or more, the share of points between 49% and 51% has a median of 0.0% and a 99th percentile of 8.7%; in that window it reached 91.8% and 100%.

  The cut is the **whole day** rather than a window of hours because each contract finished decaying at a different time, so any boundary inside the day would be arbitrary. A point-level classification was attempted and discarded: of the 287 points in the 11:45-14:00 window, 80 were clearly false, 95 clearly genuine, and 90 could not be decided either way. The removed rows are kept in full in the project repository under \`data/erratas/\`.
