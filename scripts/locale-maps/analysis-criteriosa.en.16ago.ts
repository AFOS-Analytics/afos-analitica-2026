...
construir('analysis-criteriosa', 'en', {
  subtitle:
    `UPDATE Aug 16, 49 days from the first round and on the FIRST DAY OF THE OFFICIAL CAMPAIGN. PRICE: there is a new confirmed reading for every contract tracked, ${CAR}. The leader stands at 66.50% and the runner-up at 29.45%. POLLS: no new national one; the most recent remains the Quaest of Aug 14, which had fresh crosstabs released over the weekend. REGISTRY: filing closed on Aug 15 and Poder360 counted 20,438 candidacies as of 7:30 pm that Saturday, noting that the figure remains incomplete because the Electoral Court is still processing filings. For the presidency there are 13 names.`,
